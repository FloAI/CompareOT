...
calculate_precision_for_combinations <- function(num_samples, perc_missing) {
  ...
  # Generate Yb1 and Yb2 as strong functions of predictors X1-X5
  Yb1_cont <- 20 + (5 * X1) + (10 * X2_num) + (2 * X3_num) - (8 * X4) + (0.3 * X5) + rnorm(num_samples, 0, 5)
  Yb2_cont <- 15 + (4 * X1) + (8 * X2_num) + (1.5 * X3_num) - (6 * X4) + (0.25 * X5) + rnorm(num_samples, 0, 4)
